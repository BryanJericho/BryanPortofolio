    ...
    return (
        <AnimatePresence mode="wait">
          ...
          >
            ...
            <Link
              href="https://github.com/Bryanjericho"
              target="_blank"
              className="border text-xs/none sm:text-sm/none font-medium relative border-white/[0.2] text-white hover:text-pink-500 px-4 py-2 rounded-full" 
            >
              <span className="block sm:hidden">
